...
def image_3_clicked(event=None):
    ...
    querry = f"insert into {quizName} values (%s,%s,%s,%s,%s,%s,%s)"
    querryWritter.execute(querry, (entry_1_value, entry_2_value, entry_3_value, entry_4_value, entry_5_value, entry_6_value, selected_value))
    conn.commit()
    selected_option.set(-1)
    entry_1.config(state="normal")
    entry_1.delete(0,END)
    entry_1.insert(0,int(entry_1_value)+1)
